 ...
 * ================
 */
const especialRouter = express.Router();
especialRouter.use(middleware.apikey);
sessionRouter.use(middleware.contactSwagger);
routes.use("/especial", especialRouter);

especialRouter.get(
  "/getGroupTypes/:sessionId",
  [middleware.sessionNameValidation, middleware.sessionValidation],
...
especialRouter.post(
  "/getBusinessCellphones/:sessionId",
  [middleware.sessionNameValidation, middleware.sessionValidation],
